...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "border-accent dark:bg-input/30 bg-accent dark:active:bg-input/50 flex  native:h-12 flex-row items-center justify-between gap-2 rounded-xl border px-3 py-2 shadow-sm shadow-black/5 sm:h-9",
        Platform.select({
